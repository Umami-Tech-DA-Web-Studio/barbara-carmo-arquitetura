...
- Página: `opendesign/mockups/barbara-carmo-prospeccao/index.html`
- Servir a partir da pasta do projeto: `python3 -m http.server 8289`
- URL direta: `http://localhost:8289/opendesign/mockups/barbara-carmo-prospeccao/`
...
- O protótipo não valida norma profissional para publicação, identidade real, licença de assets, conteúdo final, domínio, infraestrutura ou consentimentos.
- A pesquisa preliminar de CAU registrada no planejamento não libera nenhuma copy regulada.
- O formulário valida localmente e mostra sucesso demonstrativo; não envia nem persiste dados.
